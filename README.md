# UnrealSharpWeaver
UnrealSharpWeaver is a C# IL-weaving toolkit I wrote to inject IL instructions so user-written C# can interop with Unreal Engine. It was the core of UnrealSharp, letting managed code talk to native UE APIs.
